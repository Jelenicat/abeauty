...
const panel = { width: "min(1200px, 100%)", background: "linear-gradient(180deg, rgba(255,255,255,.72), rgba(255,255,255,.35))", border: "1px solid rgba(255,255,255,.5)", backdropFilter: "blur(15px) saturate(120%)", borderRadius: 28, boxShadow: "0 24px 60px rgba(0,0,0,.18)", padding: "clamp(16px,3vw,24px)" };
const title = { margin: 0, color: "#000" };
const catStack = { display: "grid", gap: 16, marginTop: 12 };
const deskCatBtn = () => ({ height: 64, borderRadius: 16, background: "rgba(255,255,255,.5)", color: "#000", fontWeight: 900, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", textAlign: "center" });
...
const modalCard = { width: "min(900px, 100%)", maxHeight: "85vh", overflow: "auto", background: "linear-gradient(180deg, rgba(255,255,255,.5), rgba(255,255,255,.4))", backdropFilter: "blur(12px)", borderRadius: 20, border: "1px solid rgba(255,255,255,.7)", boxShadow: "0 28px 70px rgba(0,0,0,.35)", padding: 18, position: "relative" };
...
const promptCard = { width: "min(520px, 100%)", background: "linear-gradient(180deg, rgba(255,255,255,.5), rgba(255,255,255,.4))", backdropFilter: "blur(16px)", border: "1px solid rgba(255,255,255,.65)", borderRadius: 20, boxShadow: "0 34px 90px rgba(0,0,0,.42)", padding: 22, position: "relative", textAlign: "center" };
const promptClose = { position: "absolute", top: 8, right: 8, background: "rgba(255,255,255,.5)", color: "#000", border: "1px solid rgba(0,0,0,.12)", borderRadius: 12, height: 36, width: 36, cursor: "pointer", display: "grid", placeItems: "center", fontSize: 18, lineHeight: 1 };
