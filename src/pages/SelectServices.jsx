...
const mobCatLabel = { position: "absolute", left: "50%", top: "50%", transform: "translate(-50%, -50%)",   background: "transparent", color: "#000", padding: "0px", borderRadius: 14, fontWeight: 900, letterSpacing: ".06em", fontSize: 13, textAlign: "center", boxShadow:none };
...
const deskCatCard = (imgUrl) => ({
  position: "relative",
  display: "block",
  width: "100%",
  height: 110,                    // malo viši na desktopu
  borderRadius: 18,
  border: "none",
  overflow: "hidden",
  cursor: "pointer",
  ...
  background: `
    linear-gradient(180deg, rgba(255,255,255,0) 40%, rgba(0,0,0,.12) 100%),
