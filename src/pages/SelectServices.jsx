...
const mobCatLabel = { position: "absolute", left: "50%", top: "50%", transform: "translate(-50%, -50%)",   background: "transparent", color: "#000", padding: "0px", borderRadius: 14, fontWeight: 900, letterSpacing: ".06em", fontSize: 13, textAlign: "center" };
